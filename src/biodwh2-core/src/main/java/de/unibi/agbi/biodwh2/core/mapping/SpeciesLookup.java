...
public final class SpeciesLookup {
    ...
    public static final Entry FELIS_CATUS = new Entry(null, "Felis catus", 9685, null);
    ...
    public static final Entry MELEAGRIS_GALLOPAVO = new Entry(null, "Meleagris gallopavo", 9103, null);
    ...
    public static final Entry SACCHAROMYCES_CEREVISIAE = new Entry(null, "Saccharomyces cerevisiae", 4932, null);
    ...
    public static final Entry VESICULAR_STOMATITIS_INDIANA_VIRUS = new Entry(null, "Vesicular stomatitis Indiana virus",
                                                                             null, null);
    public static final Entry VICUGNA_PACOS = new Entry(null, "Vicugna pacos", 30538, null);
    ...
    private static final Entry[] ENTRIES = new Entry[]{
            ACACIA_AURICULIFORMIS, ACACIA_MANGIUM, ACYRTHOSIPHON_PISUM, AEDES_AEGYPTI, AEGILOPS_TAUSCHII,
            AIPTASIA_PALLIDA, ALLIGATOR_MISSISSIPPIENSIS, AMBORELLA_TRICHOPODA, AMPHIMEDON_QUEENSLANDICA,
            ANAS_PLATYRHYNCHOS, ANOLIS_CAROLINENSIS, ANOPHELES_GAMBIAE, APHIS_GOSSYPII, APIS_MELLIFERA,
            AQUILEGIA_CAERULEA, ARABIDOPSIS_LYRATA, ARABIDOPSIS_THALIANA, ARACHIS_HYPOGAEA, ARTIBEUS_JAMAICENSIS,
            ASCARIS_SUUM, ASPARAGUS_OFFICINALIS, ASTATOTILAPIA_BURTONI, ATELES_GEOFFROYI, AVICENNIA_MARINA,
            BACTROCERA_DORSALIS, BISTON_BETULARIA, BOMBYX_MORI, BOS_TAURUS, BRACHYPODIUM_DISTACHYON,
            BRANCHIOSTOMA_BELCHERI, BRANCHIOSTOMA_FLORIDAE, BRASSICA_NAPUS, BRASSICA_OLERACEA, BRASSICA_RAPA,
            BRUGIA_MALAYI, BRUGIA_PAHANGI, BRUGUIERA_CYLINDRICA, BRUGUIERA_GYMNORHIZA, BUBALUS_BUBALIS,
            CAENORHABDITIS_BRENNERI, CAENORHABDITIS_BRIGGSAE, CAENORHABDITIS_ELEGANS, CAENORHABDITIS_REMANEI,
            CALLITHRIX_JACCHUS, CALLORHINCHUS_MILII, CAMELINA_SATIVA, CANIS_FAMILIARIS, CAPITELLA_TELETA, CAPRA_HIRCUS,
            CARASSIUS_AURATUS, CARICA_PAPAYA, CAVIA_PORCELLUS, CEREBRATULUS_LACTEUS, CHLAMYDOMONAS_REINHARDTII,
            CHRYSEMYS_PICTA, CIONA_INTESTINALIS, CIONA_SAVIGNYI, CITRUS_CLEMENTINA, CITRUS_RETICULATA, CITRUS_SINENSIS,
            CITRUS_TRIFOLIATA, COLUMBA_LIVIA, CRICETULUS_GRISEUS, CUCUMIS_MELO, CUCUMIS_SATIVUS, CULEX_QUINQUEFASCIATUS,
            CUNNINGHAMIA_LANCEOLATA, CYNARA_CARDUNCULUS, CYPRINUS_CARPIO, DANIO_RERIO, DAPHNIA_PULEX,
            DASYPUS_NOVEMCINCTUS, DAUBENTONIA_MADAGASCARIENSIS, DICTYOSTELIUM_DISCOIDEUM, DIGITALIS_PURPUREA,
            DINOPONERA_QUADRICEPS, DROSOPHILA_ANANASSAE, DROSOPHILA_ERECTA, DROSOPHILA_GRIMSHAWI,
            DROSOPHILA_MELANOGASTER, DROSOPHILA_MOJAVENSIS, DROSOPHILA_PERSIMILIS, DROSOPHILA_PSEUDOOBSCURA,
            DROSOPHILA_SECHELLIA, DROSOPHILA_SIMULANS, DROSOPHILA_VIRILIS, DROSOPHILA_WILLISTONI, DROSOPHILA_YAKUBA,
            ECHINOCOCCUS_GRANULOSUS, ECHINOCOCCUS_MULTILOCULARIS, ECHINOPS_TELFAIRI, ECTOCARPUS_SILICULOSUS,
            ELAEIS_GUINEENSIS, ELECTROPHORUS_ELECTRICUS, EPSTEIN_BARR_VIRUS, EPTESICUS_FUSCUS, EQUUS_CABALLUS,
            EUGENIA_UNIFLORA, FASCIOLA_HEPATICA, FELIS_CATUS, FESTUCA_ARUNDINACEA, FRAGARIA_VESCA, FUGU_RUBRIPES,
            GADUS_MORHUA, GALLID_ALPHAHERPESVIRUS_2, GALLUS_GALLUS, GLOTTIDIA_PYRAMIDATA, GLYCINE_MAX, GLYCINE_SOJA,
            GORILLA_GORILLA, GOSSYPIUM_ARBOREUM, GOSSYPIUM_HERBACEUM, GOSSYPIUM_HIRSUTUM, GOSSYPIUM_RAIMONDII,
            GYRODACTYLUS_SALARIS, HAEMONCHUS_CONTORTUS, HALIOTIS_RUFESCENS, HELIANTHUS_ANNUUS, HELIANTHUS_ARGOPHYLLUS,
            HELIANTHUS_CILIARIS, HELIANTHUS_EXILIS, HELIANTHUS_PARADOXUS, HELIANTHUS_PETIOLARIS, HELIANTHUS_TUBEROSUS,
            HELICONIUS_MELPOMENE, HELIGMOSOMOIDES_POLYGYRUS, HEVEA_BRASILIENSIS, HIPPOGLOSSUS_HIPPOGLOSSUS,
            HOMO_SAPIENS, HORDEUM_VULGARE, HUMAN_CYTOMEGALOVIRUS, HYDRA_MAGNIPAPILLATA, ICTALURUS_PUNCTATUS,
            IXODES_SCAPULARIS, KAPOSI_SARCOMA_ASSOCIATED_HERPESVIRUS, LAGOTHRIX_LAGOTRICHA, LEMUR_CATTA,
            LEUCOSOLENIA_COMPLICATA, LINUM_USITATISSIMUM, LOCUSTA_MIGRATORIA, LOTTIA_GIGANTEA, LOTUS_JAPONICUS,
            LYTECHINUS_VARIEGATUS, MACACA_MULATTA, MACACA_NEMESTRINA, MACROPUS_EUGENII, MALUS_DOMESTICA, MANDUCA_SEXTA,
            MANIHOT_ESCULENTA, MARCHANTIA_POLYMORPHA, MARSUPENAEUS_JAPONICUS, MAYETIOLA_DESTRUCTOR, MEDICAGO_TRUNCATULA,
            MELEAGRIS_GALLOPAVO, MELIBE_LEONINA, MESOCESTOIDES_CORTI, METRIACLIMA_ZEBRA, MICROCEBUS_MURINUS,
            MONODELPHIS_DOMESTICA, MUS_MUSCULUS, NASONIA_GIRAULTI, NASONIA_LONGICORNIS, NASONIA_VITRIPENNIS,
            NEMATOSTELLA_VECTENSIS, NEOLAMPROLOGUS_BRICHARDI, NICOTIANA_TABACUM, NOMASCUS_LEUCOGENYS,
            NOTHOBRANCHIUS_FURZERI, OIKOPLEURA_DIOICA, ONCORHYNCHUS_MYKISS, OPHIOPHAGUS_HANNAH, OREOCHROMIS_NILOTICUS,
            ORNITHORHYNCHUS_ANATINUS, ORYCTOLAGUS_CUNICULUS, ORYZA_SATIVA, ORYZIAS_LATIPES, OTOLEMUR_GARNETTII,
            OVIS_ARIES, PAEONIA_LACTIFLORA, PAN_PANISCUS, PAN_TROGLODYTES, PANAGRELLUS_REDIVIVUS, PANAX_GINSENG,
            PAPAVER_SOMNIFERUM, PAPIO_HAMADRYAS, PARALICHTHYS_OLIVACEUS, PARASTEATODA_TEPIDARIORUM, PATIRIA_MINIATA,
            PETROMYZON_MARINUS, PHAEODACTYLUM_TRICORNUTUM, PHASEOLUS_VULGARIS, PHYSCOMITRELLA_PATENS,
            PHYTOPHTHORA_INFESTANS, PHYTOPHTHORA_RAMORUM, PHYTOPHTHORA_SOJAE, PICEA_ABIES, PINUS_DENSATA, PINUS_TAEDA,
            PLUTELLA_XYLOSTELLA, POLISTES_CANADENSIS, PONGO_PYGMAEUS, POPULUS_EUPHRATICA, POPULUS_TRICHOCARPA,
            PRISTIONCHUS_PACIFICUS, PRUNUS_MUME, PRUNUS_PERSICA, PTEROPUS_ALECTO, PUNDAMILIA_NYEREREI, PYGATHRIX_BIETI,
            PYTHON_BIVITTATUS, RATTUS_NORVEGICUS, REHMANNIA_GLUTINOSA, RHIPICEPHALUS_MICROPLUS, RICINUS_COMMUNIS,
            SACCHAROMYCES_CEREVISIAE, SACCHARUM_OFFICINARUM, SACCOGLOSSUS_KOWALEVSKII, SAGUINUS_LABIATUS,
            SAIMIRI_BOLIVIENSIS, SALICORNIA_EUROPAEA, SALMO_SALAR, SALVIA_MILTIORRHIZA, SALVIA_SCLAREA,
            SARCOPHILUS_HARRISII, SCHISTOSOMA_JAPONICUM, SCHISTOSOMA_MANSONI, SCHMIDTEA_MEDITERRANEA,
            SELAGINELLA_MOELLENDORFFII, SETARIA_ITALICA, SOLANUM_LYCOPERSICUM, SOLANUM_TUBEROSUM, SORGHUM_BICOLOR,
            SPODOPTERA_FRUGIPERDA, STRIGAMIA_MARITIMA, STRONGYLOCENTROTUS_PURPURATUS, STRONGYLOIDES_RATTI, SUS_SCROFA,
            SYCON_CILIATUM, SYMBIODINIUM_MICROADRIATICUM, SYMPHALANGUS_SYNDACTYLUS, TAENIOPYGIA_GUTTATA,
            TEREBRATULINA_RETUSA, TETRANYCHUS_URTICAE, TETRAODON_NIGROVIRIDIS, THEOBROMA_CACAO, TRIBOLIUM_CASTANEUM,
            TRIOPS_CANCRIFORMIS, TRITICUM_AESTIVUM, TRITICUM_TURGIDUM, TUPAIA_CHINENSIS,
            VESICULAR_STOMATITIS_INDIANA_VIRUS, VICUGNA_PACOS, VIGNA_UNGUICULATA, VITIS_VINIFERA, VRIESEA_CARINATA,
            XENOPUS_LAEVIS, XENOPUS_TROPICALIS, XENOTURBELLA_BOCKI, ZEA_MAYS
    };
