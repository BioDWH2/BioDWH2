...
/**
 * <a href="https://psicquic.github.io/MITAB27Format.html">https://psicquic.github.io/MITAB27Format.html</a>
 * <p>
 * The MITAB27 format is an extention of the PSI-MI 2.5 (1) and 2.6 standard. It has been derived from the tabular
 * format provided by BioGrid. MITAB27 only describes binary interactions, one pair of interactors per row. Columns are
 * separated by tabulations. Tools allowing to manipulate this data format are available (2).
 * <p>
...
public class PsiMiTab27Entry {
    ...
    /**
     * negative Boolean value to distinguish positive interactions (false) from negative interactions (true). By
     * default, if the column is empty ('-'), the negative value is considered to be false (positive interaction). Ex:
     * true
     */
