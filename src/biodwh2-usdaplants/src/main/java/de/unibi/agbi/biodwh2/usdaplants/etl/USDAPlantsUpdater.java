...
public class USDAPlantsUpdater extends Updater<USDAPlantsDataSource> {
    private static final String DOWNLOAD_URL_PREFIX = "https://plants.usda.gov/Data/";
    ...
    protected boolean tryUpdateFiles(final Workspace workspace) throws UpdaterException {
        ...
        try {
            FileUtils.copyURLToFile(new URL(DOWNLOAD_URL_PREFIX + PLANT_LIST_FILE_NAME), newFile);
            return true;
        } catch (IOException e) {
