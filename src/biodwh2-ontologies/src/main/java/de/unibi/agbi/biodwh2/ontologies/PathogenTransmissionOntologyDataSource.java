...
public class PathogenTransmissionOntologyDataSource extends SingleOBOOntologyDataSource {
    private static final Pattern VERSION_PATTERN = Pattern.compile("(\\d{4})-(\\d{2})-(\\d{2})");
    private static final String FILE_NAME = "trans.obo";

    @Override
    public String getId() {
        return "PathogenTransmissionOntology";
    }
