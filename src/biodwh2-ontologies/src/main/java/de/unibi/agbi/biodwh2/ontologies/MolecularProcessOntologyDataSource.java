...
public class MolecularProcessOntologyDataSource extends SingleOBOOntologyDataSource {
    static final String FILE_NAME = "mop.obo";

    @Override
    public String getId() {
        return "MolecularProcessOntology";
    }

    @Override
    public String getFullName() {
        return "Molecular Process Ontology (MOP)";
    }
