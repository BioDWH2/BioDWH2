...
public class ChemicalMethodsOntologyDataSource extends SingleOBOOntologyDataSource {
    static final String FILE_NAME = "chmo.obo";

    @Override
    public String getId() {
        return "ChemicalMethodsOntology";
    }

    @Override
    protected String getDownloadUrl() {
        return "https://raw.githubusercontent.com/rsc-ontologies/rsc-cmo/master/" + FILE_NAME;
    }
