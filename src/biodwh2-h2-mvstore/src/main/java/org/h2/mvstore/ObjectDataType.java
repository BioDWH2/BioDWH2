...
public class ObjectDataType implements DataType {
    ...
    /**
     * For very common values (e.g. 0 and 1) we save space by encoding the value in the tag. e.g. TAG_BOOLEAN_TRUE and
     * TAG_FLOAT_0.
     */
    ...
    static final Class<?>[] COMMON_CLASSES = {
            ...
            Object.class, Boolean.class, Byte.class, Short.class, Character.class, Integer.class, Long.class,
            BigInteger.class, Float.class, Double.class, BigDecimal.class, String.class, UUID.class, Date.class
    };
    ...
    /**
     * Compare the contents of two byte arrays. If the content or length of the first array is smaller than the second
     * array, -1 is returned. If the content or length of the second array is smaller than the first array, 1 is
    ...
    static class ObjectArrayType extends AutoDetectDataType {
        ...
        public int getMemory(Object obj) {
            ...
            // we say they are larger, because these objects use quite a lot of disk space
            return size * 2;
        }
        ...
        public Object read(ByteBuffer buff, int tag) {
            ...
            try {
                ...
                throw DataUtils.newIllegalStateException(DataUtils.ERROR_SERIALIZATION,
                                                         "Could not create array of type {0} length {1}", clazz, len,
                                                         e);
            }
    ...
    static class SerializedObjectType extends AutoDetectDataType {
        ...
        public int compare(Object aObj, Object bObj) {
            ...
            // TODO ensure comparable type (both may be comparable but not with each other)
