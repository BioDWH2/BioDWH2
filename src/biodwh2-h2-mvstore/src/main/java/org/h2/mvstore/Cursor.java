...
public class Cursor<K, V> implements Iterator<K> {
    ...
    /**
     * Skip over that many entries. This method is relatively fast (for this map implementation) even if many entries
     * need to be skipped.
     *
    ...
    /**
     * Fetch the next entry that is equal or larger than the given key, starting from the given page. This method
     * retains the stack.
     *
