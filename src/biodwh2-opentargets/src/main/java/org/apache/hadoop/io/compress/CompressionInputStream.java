 ...
 * reposition the underlying input stream then call {@link #resetState()}, without having to also synchronize client
 * buffers.
 */
public abstract class CompressionInputStream extends InputStream implements Seekable {
    ...
    /**
     * Reset the decompressor to its initial state and discard any buffered data, as the underlying stream may have been
     * repositioned.
     */
