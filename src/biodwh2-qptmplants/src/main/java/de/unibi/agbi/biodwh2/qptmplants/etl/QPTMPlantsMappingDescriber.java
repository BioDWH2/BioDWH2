...
public class QPTMPlantsMappingDescriber extends MappingDescriber {
    public QPTMPlantsMappingDescriber(final DataSource dataSource) {
        super(dataSource);
    }

    @Override
    public NodeMappingDescription[] describe(final Graph graph, final Node node, final String localMappingLabel) {
        if (QPTMPlantsGraphExporter.PROTEIN_LABEL.equals(localMappingLabel))
            return describeProteinNode(node);
        if (QPTMPlantsGraphExporter.ORGANISM_LABEL.equals(localMappingLabel))
    ...
    protected String[] getNodeMappingLabels() {
        return new String[]{QPTMPlantsGraphExporter.PROTEIN_LABEL, QPTMPlantsGraphExporter.ORGANISM_LABEL};
    }
