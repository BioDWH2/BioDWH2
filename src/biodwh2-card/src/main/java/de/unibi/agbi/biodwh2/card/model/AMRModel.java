...
/**
 * A CARD (Comprehensive Antibiotic Resistance Database) antimicrobial resistance model entry: an ARO term together
 * with its detection parameters and reference sequences.
 */
public final class AMRModel {
