...
public class CmdArgs {
    ...
    public boolean help;
    @CommandLine.Option(names = {"--version"}, description = "Print the BioDWH2 version and check for updates", order = 1)
    ...
    @CommandLine.Option(names = {
            "-u", "--update"
    }, arity = "1..3", paramLabel = "<workspacePath> [<dataSourceId> <version>]", hideParamSyntax = true, description = "Update all data sources of a workspace", order = 14)
